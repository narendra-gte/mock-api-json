class ProductsController < ApplicationController
  ...
  private
    ...
    def product_params
      params.require(:product).permit(:category_id, :business_id, :product_type_id, :title, :description, :show_discount, :gifting_enabled, :sharing_enabled, :mobile_call_enabled)
    end
end
